<div class="row">
    <div class="col-lg-12">
      ...
      <form action="loi_uniforme" method="POST">
          <div class="form-group">
              <label for="taillePopulation">Taille de la population</label>
              <input type="text" class="form-control" id="taillePopulation" name="taillePopulation" value="1000">
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
              ...
              <input type="text" class="form-control" id="borneMaximale" name="borneMaximale" value="1">
          </div>
          <div class="form-group">
              <label for="nbrClasses">Nombre de classes</label>
              <input type="text" class="form-control" id="nbrClasses" name="nbrClasses" value="10">
              <input type="hidden" id="nomLoi" name="nomLoi" value="uniforme">
          </div>
