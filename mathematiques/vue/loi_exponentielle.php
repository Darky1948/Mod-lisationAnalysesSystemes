    ...
    <div class="col-lg-12">
      ...
      <form action="" method="POST">
          ...
          <div class="form-group">
              ...
              <input type="text" class="form-control" id="borneMaximale" name="borneMaximale" value="300">
          </div>
          <div class="form-group">
              <label for="lambda">Lambda</label>
              <input type="text" class="form-control" id="lambda" name="lambda" value="0.5">
          </div>
          <div class="form-group">
              <label for="nbrClasses">Nombre de classes</label>
              <input type="text" class="form-control" id="nbrClasses" name="nbrClasses" value="1000">
              <input type="hidden" id="nomLoi" name="nomLoi" value="exponentielle">
          </div>
